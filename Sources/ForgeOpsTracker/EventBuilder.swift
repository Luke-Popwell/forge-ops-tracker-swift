...
public enum EventBuilder {
    ...
    public static func buildEvent(exception: NSException, configuration: Configuration, context: [String: Any]?) -> [String: Any] {
        buildEvent(
    ...
    public static func buildEvent(error: Error, configuration: Configuration, context: [String: Any]?) -> [String: Any] {
    ...
    private static func buildEvent(exceptionClass: String, message: String, backtrace: [[String: Any]], configuration: Configuration, context: [String: Any]?) -> [String: Any] {
        ...
        guard configuration.scrubPII, let scrubbed = PiiScrubber.scrub(payload, key: nil) as? [String: Any] else {
            return payload
        }
        return scrubbed
    }
